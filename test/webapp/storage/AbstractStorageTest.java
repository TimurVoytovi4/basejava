...
public abstract class AbstractStorageTest {
    ...
    static {
        ...
        R2.setContact(ContactType.MOBILE, "98724");
        R2.setContact(ContactType.GITHUB, "sssr");
        R3.setContact(ContactType.HOME_PAGE, "mail1.ru");
        R3.setContact(ContactType.PHONE, "11189");
        R4.setContact(ContactType.MAIL, "ik@ya.ru");
        R4.setContact(ContactType.PHONE, "9871");
    ...
    public void update() {
        ...
        newResume.setContact(ContactType.PHONE,"322-223");
        newResume.setContact(ContactType.HOME_PHONE,"3694");
