...
- Реализация webapp.storage.Storage используя <a href="https://habrahabr.ru/post/60317/">сериализацию</a>.
...
- Реализовать webapp.storage.Storage через java.nio.file.Path.
